"""
SuperCodex pytest plugin

Auto-loaded when supercodex is installed.
Provides PM Agent fixtures and hooks for enhanced testing.

Entry point registered in pyproject.toml:
    [project.entry-points.pytest11]
    supercodex = "supercodex.pytest_plugin"
"""
...
def pytest_configure(config):
    """
    Register SuperCodex plugin and custom markers
...
def pytest_report_header(config):
    """Add SuperCodex version to pytest header"""
    from . import __version__

    return f"SuperCodex: {__version__}"
